...
set winfile0 [open WinFile_NewReno w]
...
$tcp0 set fid_ 0       ;# TCP variant (change to Tahoe  as needed)
...
$tcp1 set fid_ 1        ;# TCP variant (change to Tahoe  as needed)
...
$tcp2 set fid_ 2        ;# TCP variant (change to Tahoe  as needed)
...
$tcp3 set fid_ 3      ;# TCP variant (change to Tahoe  as needed)
...
$tcp4 set fid_ 4        ;# TCP variant (change to Tahoe  as needed)
...
proc finish {} {
    ...
    exec xgraph WinFile_NewReno -x_range 0 20  -pdf -title_x "Time (s)" -title_y "Window Size" -title "NewReno Congestion Window"
